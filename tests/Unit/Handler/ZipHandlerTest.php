...
class ZipHandlerTest extends TestCase
{
    ...
    public function test_將byte陣列進行壓縮_傳入target有值_應回傳byte陣列且內容為string()
    {
        // arrange
        // 產生假 Candidate 物件
        ...
        // act
        $byteArray = $this->zipHandler->perform($candidateStub, $targetStub);
    ...
    public function test_將byte陣列進行壓縮_傳入target為空陣列_應回傳空陣列()
    {
        // arrange
        // 產生假 Candidate 物件
        $candidateStub = $this->createFakeCandidate();
